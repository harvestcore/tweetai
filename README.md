With this project I want to learn how to create a simple AI using Keras. The main idea is to create an AI that learns how to generate tweets based on the timelines of some Twitter users.
